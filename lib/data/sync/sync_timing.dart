...
class SyncTiming {
  ...
  static const _exponentialFactor = 5.0;
  ...
  void resetTiming() {
    ...
    _attempts = 0;
    logger.i('Sync timing reset to base delay: $_baseDelay');
  }
  ...
  void increaseDelay() {
    ...
    _attempts++;
    logger.i('Sync delay increased to: $_currentDelay (attempt $_attempts)');
  }
