...
import '../core/database/sync_database.dart' as _i824;
...
import '../data/sync/transaction_type_handler.dart' as _i641;
...
_i174.GetIt $initGetIt(
  ...
  gh.lazySingleton<_i641.TransactionTypeHandler>(
      () => _i641.TransactionTypeHandler(
  ...
  gh.lazySingleton<Set<_i877.SyncTypeHandler<dynamic, dynamic>>>(() =>
      syncModule.provideSyncTypeHandlers(gh<_i641.TransactionTypeHandler>()));
  ...
  gh.lazySingleton<_i118.TransactionRepository>(
      () => _i114.TransactionRepositoryImpl(
            syncHandler: gh<_i641.TransactionTypeHandler>(),
  ...
  gh.lazySingleton<_i824.SynchAppDatabase>(() => _i824.SynchAppDatabase(
